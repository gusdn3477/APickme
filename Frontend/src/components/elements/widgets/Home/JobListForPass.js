...
import InterviewFinalCard from "./InterviewFinalCard";
import JobListForProcessDetail from "./JobListForProcessDetail";
import { Link } from "react-router-dom";
import FinalProcessCard from "./FinalprocessCard";


export default function JobListForPass() {
